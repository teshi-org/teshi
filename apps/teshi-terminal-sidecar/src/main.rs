...
use teshi_engine::ProcessState;
use teshi_engine::ScreenGrid;
...
fn require_pty(pty: &mut Option<PtySession>) -> Result<&mut PtySession, Value> {
    pty.as_mut()
