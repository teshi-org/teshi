...
Named LLM model profile persistence under Teshi app data: CRUD, active-profile selection, built-in providers/defaults, and one-time migration from legacy `llm-config.json`.
