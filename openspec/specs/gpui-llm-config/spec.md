...
LLM settings UI and persistence/API used by the shared GPUI shell: multi-profile editing, active-profile projection, and configured/masked status (no chat UI).
