...
Ensure terminal initialization and diagnostic logging works correctly in the desktop Tauri application, providing visibility into terminal lifecycle events for debugging.
