# gpui-winapp-preview Specification

## Purpose

Live WinApp JPEG preview behavior shared by the native and WASM GPUI shells,
including attachment configuration, visible connection states, aspect-ratio
preservation, and bounded latest-frame delivery.
