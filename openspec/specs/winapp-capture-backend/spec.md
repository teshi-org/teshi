# winapp-capture-backend Specification

## Purpose

Define WinApp window capture backend selection, fallback behavior, lifecycle,
and compatibility requirements for preview and screenshot delivery.
