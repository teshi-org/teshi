...
pub fn stop_terminal(rt: &TeshiEngine) -> Result<(), String> {
...
pub fn resize_terminal(rt: &TeshiEngine, cols: u16, rows: u16) -> Result<(), String> {
    if cols == 0 || rows == 0 {
        return Ok(());
    }
...
pub async fn spawn_terminal(rt: Arc<TeshiEngine>, cols: u16, rows: u16) -> Result<(), String> {
...
pub fn write_terminal(rt: &TeshiEngine, data: String) -> Result<(), String> {
