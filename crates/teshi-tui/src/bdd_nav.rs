...
use teshi_core::gherkin_lang::{GherkinLanguage, StepKeywordType, StructuralType};
...
mod tests {
    ...
    fn en() -> &'static GherkinLanguage {
        teshi_core::gherkin_lang::GherkinLanguages::global().get("en")
    }
    ...
    fn test_background_header_line_zh() {
        let zh = teshi_core::gherkin_lang::GherkinLanguages::global().get("zh-CN");
        let line = "  背景:";
